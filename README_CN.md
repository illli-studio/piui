...
1. **智能模板（默认，无需 API 密钥）**
   - 无需配置即可离线使用
   - 10种精美配色方案
   - 多种场景类型（YouTube、Instagram、引言、促销、TikTok 等）
   - 自动生成渐变背景和装饰元素

2. **高级 AI（需要 MiniMax API 密钥）**
   - 从以下地址获取 API 密钥：https://platform.minimaxi.com
   - 在 AI 面板中点击"API Settings"
   - 输入您的 API 密钥并点击"Save Key"
   - 更智能、更可定制的生成
